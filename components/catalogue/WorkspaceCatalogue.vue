...
export default {
  data() {
   ...
   methods: {
    ...
    getIdeal: function() {
      let localThis = this;
      axios
        .get(`https://apicovid19.coredumped.es//workspace/ideal`, this.config)
        .then(response => {
     ...
     reserveSpace(id) {
      let localThis = this;
      axios
        .put("https://apicovid19.coredumped.es//workspace/reserve/"+id, {
          available: false,
        }, this.config)
     ...
     createRecord(id) {
       let localThis = this;
        axios
          .post("https://apicovid19.coredumped.es//record/", {
            user: this.userId,
            workspace: id,
            left: false
          }, this.config)
  ...
  mounted() {
    ...
    axios
      .get(`https://apicovid19.coredumped.es//workspace/available`, this.config)
      .then(response => {
    ...
    axios
      .post(`https://apicovid19.coredumped.es//user/getUserIdByToken`, {
